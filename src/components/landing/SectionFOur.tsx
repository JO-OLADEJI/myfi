...
export const SectionFour = () => {
  return (
    <div className="min-h-screen bg-primary gap-20  md:py-10 text-white flex flex-col justify-center items-center">
      <div className="flex flex-col gap-10">
        <p className="text-center text-white text-[24px] md:text-[45px] font-bold">
          We are breaking barriers with
          <br /> technology in the finance world
        </p>
        <p className="text-center text-white text-opacity-90 md:text-[22px] font-normal font-['Inter'] md:leading-[34px]">
